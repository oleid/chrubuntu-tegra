...
# Scipt by JensM published at
# https://devtalk.nvidia.com/default/topic/774354/embedded-systems/l4t-on-acer-chromebook-13-cb5/3/
...
echo
echo "install tools"
sudo apt-get -y install cgpt vboot-kernel-utils device-tree-compiler build-essential u-boot-tools ncurses-dev
